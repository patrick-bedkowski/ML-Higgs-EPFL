...
% Divide the content of the document to seperate files
% Make here the outline of the report
\input{content/0_abstract.tex}
\input{content/1_introduction.tex}
\input{content/2_structure_of_paper.tex}

% TODO: finish the outline, create seperate files ...
